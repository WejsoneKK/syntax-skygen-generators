package eu.wejsonekk.syntaxstudio.skygengenerator.configuration;
...
public class ConfigurationService {
    ...
    public ConfigurationService(NoticeResolverRegistry noticeResolverRegistry) {
    ...
    public <T extends OkaeriConfig> T create(Class<T> config, File file) {
        ...
        YamlSnakeYamlConfigurer yamlConfigurer = new YamlSnakeYamlConfigurer();
